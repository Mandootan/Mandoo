...
class Mybinance():
    ...
    def order(self, bal_symbol, order_symbol, btc_open_amt, btc_leverage):
        if(order_symbol == "BTC/USDT"):
            ...
            if(btc_long_qty_01 > 0 and btc_long_open_notice == 1):
                ...
                btc_long_qty_01 = float(btc_L_position['positionAmt'])
                btc_long_entryprice_01 = float(btc_L_position['entryPrice'])
                telbot.sendMessage(chat_id=id, text="BTC Long Open" + "\n" + "entry price : " + str(btc_long_entryprice_01) + "\n" + "amount : " + str(btc_long_qty_01))
                btc_long_open_notice = 0

            # if(btc_long_qty_01 > 0 and btc_long_open_notice == 2):
            #     for position in positions:
            #         if position["symbol"] == bal_symbol and position["positionSide"] == "LONG":
            #             btc_L_position = position
            #     btc_long_qty_01 = float(btc_L_position['positionAmt'])
            #     btc_long_entryprice_01 = float(btc_L_position['entryPrice'])
            #     bot.sendMessage(chat_id=id, text="BTC Long Open(shortage)" + "\n" + "entry price : " + str(btc_long_entryprice_01) + "\n" + "amount : " + str(btc_long_qty_01))
            #     btc_long_open_notice = 0

            # if(btc_short_qty_01 < 0 and btc_short_open_notice == 2):
            #     for position in positions:
            #         if position["symbol"] == bal_symbol and position["positionSide"] == "SHORT":
            #             btc_S_position = position
            #     btc_short_qty_01 = float(btc_S_position['positionAmt'])
            #     btc_short_entryprice_01 = float(btc_S_position['entryPrice'])
            #     bot.sendMessage(chat_id=id, text="BTC Short Open(shortage)" + "\n" + "entry price : " + str(btc_short_entryprice_01) + "\n" + "amount : " + str(btc_short_qty_01))
            #     btc_short_open_notice = 0
            ...
            if (btc_long_qty_01 == 0 and
                btc_ticker_df_01['ema2'][-2] < btc_ticker_df_01['ma1200'][-2] * 0.9996 and
                btc_ticker_df_01['ema2'][-1] > btc_ticker_df_01['ma1200'][-1] * 0.9996):
            ...
            elif (btc_long_qty_01 > 0 and btc_long_qty_01 < btc_open_amt and
                btc_ticker_df_01['ema2'][-2] < btc_ticker_df_01['ma1200'][-2] * 0.9996 and
                btc_ticker_df_01['ema2'][-1] > btc_ticker_df_01['ma1200'][-1] * 0.9996):
                btc_long_loss_cut = btc_ticker_df_01[  'min_low_20'][-1]
            ...
            if (btc_short_qty_01 == 0 and
                btc_ticker_df_01['ema2'][-2] > btc_ticker_df_01['ma1200'][-2] * 1.0004 and
                btc_ticker_df_01['ema2'][-1] < btc_ticker_df_01['ma1200'][-1]* 1.0004):
            ...
            elif (btc_short_qty_01 < 0 and btc_short_qty_01 > btc_open_amt * -1 and
                btc_ticker_df_01['ema2'][-2] > btc_ticker_df_01['ma1200'][-2] * 1.0004 and
                btc_ticker_df_01['ema2'][-1] < btc_ticker_df_01['ma1200'][-1]* 1.0004):
            ...
            ###############################################################################################
            if (btc_long_qty_01 > 0 and
                btc_current_price < btc_long_loss_cut and
                btc_long_roe_01 <= -0.2):
                telbot.sendMessage(chat_id=id, text="BTC Long lose cut" + "\n" + str(btc_long_roe_01) + "\n" + "amount : " + str(btc_long_qty_01))            
                params = {'positionSide' : 'LONG'}
                data = binance.create_market_sell_order(order_symbol, btc_open_amt, params)
                btc_long_loss_cut = 0
                btc_long_roe_01 = 0
            ...
            if (btc_long_qty_01 > 0 and btc_long_roe_01 < -0.45):
                telbot.sendMessage(chat_id=id, text="BTC Long lose cut" + "\n" + str(btc_long_roe_01) + "\n" + "amount : " + str(btc_long_qty_01))            
                params = {'positionSide' : 'LONG'}
                data = binance.create_market_sell_order(order_symbol, btc_open_amt, params)
                btc_long_loss_cut = 0
            ...
            if (btc_long_qty_01 > 0 and btc_long_max_roe_01 > 0.50 and 
                btc_current_price <= btc_long_entryprice_01 and btc_current_price < btc_ticker_df_01['ma1200'][-1] * 0.9996):
                telbot.sendMessage(chat_id=id, text="BTC Long 수익실현 후 lose cut" + "\n" + str(btc_long_roe_01) + "\n" + "amount : " + str(btc_long_qty_01))            
                params = {'positionSide' : 'LONG'}
            ...
            ###############################################################################################
            if (btc_short_qty_01 < 0 and
                btc_ticker_df_01['close'][-1] > btc_short_loss_cut and
                btc_short_roe_01 <= -0.2):
                telbot.sendMessage(chat_id=id, text="BTC Short lose cut" + "\n" + str(btc_short_roe_01) + "\n" + "amount : " + str(btc_short_qty_01))            
                params = {'positionSide' : 'SHORT'}
                data = binance.create_market_buy_order(order_symbol, btc_open_amt, params)
                btc_short_loss_cut = 50000
                btc_short_roe_01 = 0
            ...
            if (btc_short_qty_01 < 0 and btc_short_roe_01 < -0.45):
                telbot.sendMessage(chat_id=id, text="BTC Short lose cut" + "\n" + str(btc_short_roe_01) + "\n" + "amount : " + str(btc_short_qty_01))            
                params = {'positionSide' : 'SHORT'}
                data = binance.create_market_buy_order(order_symbol, btc_open_amt, params)
            ...
            if (btc_short_qty_01 < 0 and btc_short_max_roe_01 > 0.50 and 
                btc_current_price >= btc_short_entryprice_01 and btc_current_price > btc_ticker_df_01['ma1200'][-1] * 1.0004):
                telbot.sendMessage(chat_id=id, text="BTC Short 수익실현 후 lose cut" + "\n" + str(btc_short_roe_01) + "\n" + "amount : " + str(btc_short_qty_01))
                params = {'positionSide' : 'SHORT'}
            ...
            if  (btc_long_qty_01 == btc_open_amt and btc_long_max_roe_01 > 0.45 and btc_long_max_roe_01 * 0.9 > btc_long_roe_01):
                params = {'positionSide' : 'LONG'}
                data = binance.create_market_sell_order(order_symbol, btc_open_amt / 4, params)
                telbot.sendMessage(chat_id=id, text="BTC long profit 1st realize" + "\n" + "long max roe : " + str(btc_long_max_roe_01) + "\n" + "long roe : " + str(btc_long_roe_01))

            # elif (btc_long_qty_01 >= (btc_open_amt * 3) / 4 and btc_long_qty_01 < btc_open_amt and
            #     btc_long_roe_01 > 0.8 and
            #     btc_ticker_df_01['ma12'][-1] > btc_ticker_df_01['ema2'][-1]
            #     ):
            ...
            #     data = binance.create_market_sell_order(order_symbol, btc_open_amt / 4, params)
                ...
                btc_long_max_roe_01 > 0.88 and btc_long_max_roe_01 * 0.9 > btc_long_roe_01):
                telbot.sendMessage(chat_id=id, text="BTC long profit 2nd realize" + "\n" + "long max roe : " + str(btc_long_max_roe_01) + "\n" + "long roe : " + str(btc_long_roe_01))
                params = {'positionSide' : 'LONG'}
                data = binance.create_market_sell_order(order_symbol, btc_open_amt / 4, params)

            elif( btc_long_qty_01 > 0 and btc_long_max_roe_01 > 1.1and btc_long_roe_01 < 0.8
                and btc_long_roe_01 <= btc_long_max_roe_01 * 0.85
                # and btc_ticker_df_01['ma12'][-1] > btc_ticker_df_01['ema2'][-1]
                ):
                
                telbot.sendMessage(chat_id=id, text="BTC long profit final realize" + "\n" + "long max roe : " + str(btc_long_max_roe_01) + "\n" + "long roe : " + str(btc_long_roe_01))
                params = {'positionSide' : 'LONG'}
                data = binance.create_market_sell_order(order_symbol, btc_long_qty_01, params)
            ...
            if  (btc_short_qty_01 == btc_open_amt * -1 and
                btc_short_max_roe_01 > 0.45 and btc_short_max_roe_01 * 0.9 > btc_short_roe_01):
                telbot.sendMessage(chat_id=id, text="BTC short profit 1st realize" + "\n" + "short max roe : " + str(btc_short_max_roe_01) + "\n" + "short roe : " + str(btc_short_roe_01))
                params = {'positionSide' : 'SHORT'}
                data = binance.create_market_buy_order(order_symbol, btc_open_amt / 4, params)

            # elif (btc_short_qty_01 <= ((btc_open_amt *3) / 4) * -1 and btc_short_qty_01 > btc_open_amt * -1 and
            #     btc_short_roe_01 > 0.88 and
            #     btc_ticker_df_01['ma12'][-1] < btc_ticker_df_01['ema2'][-1]):
            ...
            #     data = binance.create_market_buy_order(order_symbol, btc_open_amt / 4, params)
                ...
                btc_short_max_roe_01 > 0.88 and btc_short_max_roe_01 * 0.9 >btc_short_roe_01):
                telbot.sendMessage(chat_id=id, text="BTC short profit 2nd realize" + "\n" + "short max roe : " + str(btc_short_max_roe_01) + "\n" + "short roe : " + str(btc_short_roe_01))
                params = {'positionSide' : 'SHORT'}
                data = binance.create_market_buy_order(order_symbol, btc_open_amt / 4, params)
            
            elif( btc_short_qty_01 < 0 and btc_short_max_roe_01 > 1.1 and btc_short_roe_01 > 0.8 and
                btc_short_roe_01 <= btc_short_max_roe_01 * 0.85
                # and btc_ticker_df_01['ma12'][-1] < btc_ticker_df_01['ema2'][-1]
                ):
                
                telbot.sendMessage(chat_id=id, text="BTC short profit final realize" + "\n" + "short max roe : " + str(btc_short_max_roe_01) + "\n" + "short roe : " + str(btc_short_roe_01))
                params = {'positionSide' : 'SHORT'}
                data = binance.create_market_buy_order(order_symbol, btc_short_qty_01 * -1, params)
    ...
    def order2(self, bal_symbol, order_symbol, xrp_open_amt, xrp_leverage):
        if(order_symbol == "XRP/USDT"):
            ...
            #xrp_stdp = round((xrp_std20[-1] / current_price * 100) ,4)
            ...
            if(xrp_long_qty_01 > 0 and xrp_long_open_notice == 1):
                ...
                xrp_long_qty_01 = float(xrp_L_position['positionAmt'])
                xrp_long_entryprice_01 = float(xrp_L_position['entryPrice'])
                telbot.sendMessage(chat_id=id, text="XRP Long Open" + "\n" + "entry price : " + str(xrp_long_entryprice_01) + "\n" + "amount : " + str(xrp_long_qty_01))
                xrp_long_open_notice = 0

            # if(xrp_long_qty_01 > 0 and xrp_long_open_notice == 2):
            #     for position in positions:
            #         if position["symbol"] == bal_symbol and position["positionSide"] == "LONG":
            #             xrp_L_position = position
            #     xrp_long_qty_01 = float(xrp_L_position['positionAmt'])
            #     xrp_long_entryprice_01 = float(xrp_L_position['entryPrice'])
            #     bot.sendMessage(chat_id=id, text="XRP Long Open(shortage)" + "\n" + "entry price : " + str(xrp_long_entryprice_01) + "\n" + "amount : " + str(xrp_long_qty_01))
            #     xrp_long_open_notice = 0

            # if(xrp_short_qty_01 < 0 and xrp_short_open_notice == 2):
            #     for position in positions:
            #         if position["symbol"] == bal_symbol and position["positionSide"] == "SHORT":
            #             xrp_S_position = position
            #     xrp_short_qty_01 = float(xrp_S_position['positionAmt'])
            #     xrp_short_entryprice_01 = float(xrp_S_position['entryPrice'])
            #     bot.sendMessage(chat_id=id, text="XRP Short Open(shortage)" + "\n" + "entry price : " + str(xrp_short_entryprice_01) + "\n" + "amount : " + str(xrp_short_qty_01))
            #     xrp_short_open_notice = 0
            ...
            if (xrp_long_qty_01 == 0 and
                xrp_ticker_df_01['ema2'][-2] < xrp_ticker_df_01['ma1200'][-2] * 0.9996 and
                xrp_ticker_df_01['ema2'][-1] > xrp_ticker_df_01['ma1200'][-1] * 0.9996):
            ...
            elif (xrp_long_qty_01 > 0 and xrp_long_qty_01 < xrp_open_amt and
                xrp_ticker_df_01['ema2'][-2] < xrp_ticker_df_01['ma1200'][-2] * 0.9996 and
                xrp_ticker_df_01['ema2'][-1] > xrp_ticker_df_01['ma1200'][-1] * 0.9996):
                xrp_long_loss_cut = xrp_ticker_df_01[  'min_low_20'][-1]
            ...
            if (xrp_short_qty_01 == 0 and
                xrp_ticker_df_01['ema2'][-2] > xrp_ticker_df_01['ma1200'][-2] * 1.0004 and
                xrp_ticker_df_01['ema2'][-1] < xrp_ticker_df_01['ma1200'][-1]* 1.0004):
            ...
            elif (xrp_short_qty_01 < 0 and xrp_short_qty_01 > xrp_open_amt * -1 and
                xrp_ticker_df_01['ema2'][-2] > xrp_ticker_df_01['ma1200'][-2] * 1.0004 and
                xrp_ticker_df_01['ema2'][-1] < xrp_ticker_df_01['ma1200'][-1]* 1.0004):
            ...
            ###############################################################################################
            if (xrp_long_qty_01 > 0 and
                xrp_current_price < xrp_long_loss_cut and
                xrp_long_roe_01 <= -0.2):
                telbot.sendMessage(chat_id=id, text="XRP Long lose cut" + "\n" + str(xrp_long_roe_01) + "\n" + "amount : " + str(xrp_long_qty_01))            
                params = {'positionSide' : 'LONG'}
                data = binance.create_market_sell_order(order_symbol, xrp_open_amt, params)
                xrp_long_loss_cut = 0
                xrp_long_roe_01 = 0
            ...
            if (xrp_long_qty_01 > 0 and xrp_long_roe_01 < -0.45):
                telbot.sendMessage(chat_id=id, text="XRP Long lose cut" + "\n" + str(xrp_long_roe_01) + "\n" + "amount : " + str(xrp_long_qty_01))            
                params = {'positionSide' : 'LONG'}
                data = binance.create_market_sell_order(order_symbol, xrp_open_amt, params)
                xrp_long_loss_cut = 0
            ...
            if (xrp_long_qty_01 > 0 and xrp_long_max_roe_01 > 0.50 and 
                xrp_current_price <= xrp_long_entryprice_01 and xrp_current_price < xrp_ticker_df_01['ma1200'][-1] * 0.9996):
                telbot.sendMessage(chat_id=id, text="XRP Long 수익실현 후 lose cut" + "\n" + str(xrp_long_roe_01) + "\n" + "amount : " + str(xrp_long_qty_01))            
                params = {'positionSide' : 'LONG'}
            ...
            ###############################################################################################
            if (xrp_short_qty_01 < 0 and
                xrp_ticker_df_01['close'][-1] > xrp_short_loss_cut and
                xrp_short_roe_01 <= -0.2):
                telbot.sendMessage(chat_id=id, text="XRP Short lose cut" + "\n" + str(xrp_short_roe_01) + "\n" + "amount : " + str(xrp_short_qty_01))            
                params = {'positionSide' : 'SHORT'}
                data = binance.create_market_buy_order(order_symbol, xrp_open_amt, params)
                xrp_short_loss_cut = 2
                xrp_short_roe_01 = 0
            ...
            if (xrp_short_qty_01 < 0 and xrp_short_roe_01 < -0.45):
                telbot.sendMessage(chat_id=id, text="XRP Short lose cut" + "\n" + str(xrp_short_roe_01) + "\n" + "amount : " + str(xrp_short_qty_01))            
                params = {'positionSide' : 'SHORT'}
                data = binance.create_market_buy_order(order_symbol, xrp_open_amt, params)
            ...
            if (xrp_short_qty_01 < 0 and xrp_short_max_roe_01 > 0.50 and 
                xrp_current_price >= xrp_short_entryprice_01 and xrp_current_price > xrp_ticker_df_01['ma1200'][-1] * 1.0004):
                telbot.sendMessage(chat_id=id, text="XRP Short 수익실현 후 lose cut" + "\n" + str(xrp_short_roe_01) + "\n" + "amount : " + str(xrp_short_qty_01))
                params = {'positionSide' : 'SHORT'}
            ...
            if  (xrp_long_qty_01 == xrp_open_amt and xrp_long_max_roe_01 > 0.45 and xrp_long_max_roe_01 * 0.9 > xrp_long_roe_01):
                params = {'positionSide' : 'LONG'}
                data = binance.create_market_sell_order(order_symbol, xrp_open_amt / 4, params)
                bot.sendMessage(chat_id=id, text="XRP long profit 1st realize" + "\n" + "long max roe : " + str(xrp_long_max_roe_01) + "\n" + "long roe : " + str(xrp_long_roe_01))

            # elif (xrp_long_qty_01 >= (xrp_open_amt * 3) / 4 and xrp_long_qty_01 < xrp_open_amt and
            #     xrp_long_roe_01 > 0.8 and
            #     xrp_ticker_df_01['ma12'][-1] > xrp_ticker_df_01['ema2'][-1]
            #     ):
            ...
            #     data = binance.create_market_sell_order(order_symbol, xrp_open_amt / 4, params)
                ...
                xrp_long_max_roe_01 > 0.88 and xrp_long_max_roe_01 * 0.9 > xrp_long_roe_01):
                telbot.sendMessage(chat_id=id, text="XRP long profit 2nd realize" + "\n" + "long max roe : " + str(xrp_long_max_roe_01) + "\n" + "long roe : " + str(xrp_long_roe_01))
                params = {'positionSide' : 'LONG'}
                data = binance.create_market_sell_order(order_symbol, xrp_open_amt / 4, params)

            elif( xrp_long_qty_01 > 0 and xrp_long_max_roe_01 > 1.1 and xrp_long_roe_01 > 0.8
                and xrp_long_roe_01 <= xrp_long_max_roe_01 * 0.85
                # and xrp_ticker_df_01['ma12'][-1] > xrp_ticker_df_01['ema2'][-1]
                ):
                
                telbot.sendMessage(chat_id=id, text="XRP long profit final realize" + "\n" + "long max roe : " + str(xrp_long_max_roe_01) + "\n" + "long roe : " + str(xrp_long_roe_01))
                params = {'positionSide' : 'LONG'}
                data = binance.create_market_sell_order(order_symbol, xrp_long_qty_01, params)
            ...
            if  (xrp_short_qty_01 == xrp_open_amt * -1 and
                xrp_short_max_roe_01 > 0.45 and xrp_short_max_roe_01 * 0.9 > xrp_short_roe_01):
                telbot.sendMessage(chat_id=id, text="XRP short profit 1st realize" + "\n" + "short max roe : " + str(xrp_short_max_roe_01) + "\n" + "short roe : " + str(xrp_short_roe_01))
                params = {'positionSide' : 'SHORT'}
                data = binance.create_market_buy_order(order_symbol, xrp_open_amt / 4, params)

            # elif (xrp_short_qty_01 <= ((xrp_open_amt *3) / 4) * -1 and xrp_short_qty_01 > xrp_open_amt * -1 and
            #     xrp_short_roe_01 > 0.88 and
            #     xrp_ticker_df_01['ma12'][-1] < xrp_ticker_df_01['ema2'][-1]):
            ...
            #     data = binance.create_market_buy_order(order_symbol, xrp_open_amt / 4, params)
                ...
                xrp_short_max_roe_01 > 0.88 and xrp_short_max_roe_01 * 0.9 >xrp_short_roe_01):
                telbot.sendMessage(chat_id=id, text="XRP short profit 2nd realize" + "\n" + "short max roe : " + str(xrp_short_max_roe_01) + "\n" + "short roe : " + str(xrp_short_roe_01))
                params = {'positionSide' : 'SHORT'}
                data = binance.create_market_buy_order(order_symbol, xrp_open_amt / 4, params)
            
            elif( xrp_short_qty_01 < 0 and xrp_short_max_roe_01 > 1.1 and xrp_short_roe_01 > 0.8 and
                xrp_short_roe_01 <= xrp_short_max_roe_01 * 0.85
                # and xrp_ticker_df_01['ma12'][-1] < xrp_ticker_df_01['ema2'][-1]
                ):
                
                telbot.sendMessage(chat_id=id, text="XRP short profit final realize" + "\n" + "short max roe : " + str(xrp_short_max_roe_01) + "\n" + "short roe : " + str(xrp_short_roe_01))
                params = {'positionSide' : 'SHORT'}
                data = binance.create_market_buy_order(order_symbol, xrp_short_qty_01 * -1, params)
    ...
    def order3(self, bal_symbol, order_symbol, doge_open_amt, doge_leverage):
        if(order_symbol == "DOGE/USDT"):
            ...
            #doge_stdp = round((doge_std20[-1] / current_price * 100) ,5)
            ...
            if(doge_long_qty_01 > 0 and doge_long_open_notice == 1):
                ...
                doge_long_qty_01 = float(doge_L_position['positionAmt'])
                doge_long_entryprice_01 = float(doge_L_position['entryPrice'])
                telbot.sendMessage(chat_id=id, text="DOGE Long Open" + "\n" + "entry price : " + str(doge_long_entryprice_01) + "\n" + "amount : " + str(doge_long_qty_01))
                doge_long_open_notice = 0

            # if(doge_long_qty_01 > 0 and doge_long_open_notice == 2):
            #     for position in positions:
            #         if position["symbol"] == bal_symbol and position["positionSide"] == "LONG":
            #             doge_L_position = position
            #     doge_long_qty_01 = float(doge_L_position['positionAmt'])
            #     doge_long_entryprice_01 = float(doge_L_position['entryPrice'])
            #     bot.sendMessage(chat_id=id, text="DOGE Long Open(shortage)" + "\n" + "entry price : " + str(doge_long_entryprice_01) + "\n" + "amount : " + str(doge_long_qty_01))
            #     doge_long_open_notice = 0

            # if(doge_short_qty_01 < 0 and doge_short_open_notice == 2):
            #     for position in positions:
            #         if position["symbol"] == bal_symbol and position["positionSide"] == "SHORT":
            #             doge_S_position = position
            #     doge_short_qty_01 = float(doge_S_position['positionAmt'])
            #     doge_short_entryprice_01 = float(doge_S_position['entryPrice'])
            #     bot.sendMessage(chat_id=id, text="DOGE Short Open(shortage)" + "\n" + "entry price : " + str(doge_short_entryprice_01) + "\n" + "amount : " + str(doge_short_qty_01))
            #     doge_short_open_notice = 0
            ...
            if (doge_long_qty_01 == 0 and
                doge_ticker_df_01['ema2'][-2] < doge_ticker_df_01['ma1200'][-2] * 0.9996 and
                doge_ticker_df_01['ema2'][-1] > doge_ticker_df_01['ma1200'][-1] * 0.9996):
            ...
            elif (doge_long_qty_01 > 0 and doge_long_qty_01 < doge_open_amt and
                doge_ticker_df_01['ema2'][-2] < doge_ticker_df_01['ma1200'][-2] * 0.9996 and
                doge_ticker_df_01['ema2'][-1] > doge_ticker_df_01['ma1200'][-1] * 0.9996):
                doge_long_loss_cut = doge_ticker_df_01[  'min_low_20'][-1]
            ...
            if (doge_short_qty_01 == 0 and
                doge_ticker_df_01['ema2'][-2] > doge_ticker_df_01['ma1200'][-2] * 1.0004 and
                doge_ticker_df_01['ema2'][-1] < doge_ticker_df_01['ma1200'][-1]* 1.0004):
            ...
            elif (doge_short_qty_01 < 0 and doge_short_qty_01 > doge_open_amt * -1 and
                doge_ticker_df_01['ema2'][-2] > doge_ticker_df_01['ma1200'][-2] * 1.0004 and
                doge_ticker_df_01['ema2'][-1] < doge_ticker_df_01['ma1200'][-1]* 1.0004):
            ...
            ###############################################################################################
            if (doge_long_qty_01 > 0 and
                doge_current_price < doge_long_loss_cut and
                doge_long_roe_01 <= -0.2):
                telbot.sendMessage(chat_id=id, text="DOGE Long lose cut" + "\n" + str(doge_long_roe_01) + "\n" + "amount : " + str(doge_long_qty_01))            
                params = {'positionSide' : 'LONG'}
                data = binance.create_market_sell_order(order_symbol, doge_open_amt, params)
                doge_long_loss_cut = 0
                doge_long_roe_01 = 0
            ...
            if (doge_long_qty_01 > 0 and doge_long_roe_01 < -0.45):
                telbot.sendMessage(chat_id=id, text="DOGE Long lose cut" + "\n" + str(doge_long_roe_01) + "\n" + "amount : " + str(doge_long_qty_01))            
                params = {'positionSide' : 'LONG'}
                data = binance.create_market_sell_order(order_symbol, doge_open_amt, params)
                doge_long_loss_cut = 0
            ...
            if (doge_long_qty_01 > 0 and doge_long_max_roe_01 > 0.50 and 
                doge_current_price <= doge_long_entryprice_01 and doge_current_price < doge_ticker_df_01['ma1200'][-1] * 0.9996):
                telbot.sendMessage(chat_id=id, text="DOGE Long 수익실현 후 lose cut" + "\n" + str(doge_long_roe_01) + "\n" + "amount : " + str(doge_long_qty_01))            
                params = {'positionSide' : 'LONG'}
            ...
            ###############################################################################################
            if (doge_short_qty_01 < 0 and
                doge_ticker_df_01['close'][-1] > doge_short_loss_cut and
                doge_short_roe_01 <= -0.2):
                telbot.sendMessage(chat_id=id, text="DOGE Short lose cut" + "\n" + str(doge_short_roe_01) + "\n" + "amount : " + str(doge_short_qty_01))            
                params = {'positionSide' : 'SHORT'}
                data = binance.create_market_buy_order(order_symbol, doge_open_amt, params)
                doge_short_loss_cut = 2
                doge_short_roe_01 = 0
            ...
            if (doge_short_qty_01 < 0 and doge_short_roe_01 < -0.45):
                telbot.sendMessage(chat_id=id, text="DOGE Short lose cut" + "\n" + str(doge_short_roe_01) + "\n" + "amount : " + str(doge_short_qty_01))            
                params = {'positionSide' : 'SHORT'}
                data = binance.create_market_buy_order(order_symbol, doge_open_amt, params)
            ...
            if (doge_short_qty_01 < 0 and doge_short_max_roe_01 > 0.50 and 
                doge_current_price >= doge_short_entryprice_01 and doge_current_price > doge_ticker_df_01['ma1200'][-1] * 1.0004):
                telbot.sendMessage(chat_id=id, text="DOGE Short 수익실현 후 lose cut" + "\n" + str(doge_short_roe_01) + "\n" + "amount : " + str(doge_short_qty_01))
                params = {'positionSide' : 'SHORT'}
            ...
            if  (doge_long_qty_01 == doge_open_amt and doge_long_max_roe_01 > 0.45 and doge_long_max_roe_01 * 0.9 > doge_long_roe_01):
                params = {'positionSide' : 'LONG'}
                data = binance.create_market_sell_order(order_symbol, doge_open_amt / 4, params)
                telbot.sendMessage(chat_id=id, text="DOGE long profit 1st realize" + "\n" + "long max roe : " + str(doge_long_max_roe_01) + "\n" + "long roe : " + str(doge_long_roe_01))

            # elif (doge_long_qty_01 >= (doge_open_amt * 3) / 4 and doge_long_qty_01 < doge_open_amt and
            #     doge_long_roe_01 > 0.8 and
            #     doge_ticker_df_01['ma12'][-1] > doge_ticker_df_01['ema2'][-1]
            #     ):
            ...
            #     data = binance.create_market_sell_order(order_symbol, doge_open_amt / 4, params)
                ...
                doge_long_max_roe_01 > 0.88 and doge_long_max_roe_01 * 0.9 > doge_long_roe_01):
                telbot.sendMessage(chat_id=id, text="DOGE long profit 2nd realize" + "\n" + "long max roe : " + str(doge_long_max_roe_01) + "\n" + "long roe : " + str(doge_long_roe_01))
                params = {'positionSide' : 'LONG'}
                data = binance.create_market_sell_order(order_symbol, doge_open_amt / 4, params)

            elif( doge_long_qty_01 > 0 and doge_long_max_roe_01 > 1.1 and doge_long_roe_01 > 0.8
                and doge_long_roe_01 <= doge_long_max_roe_01 * 0.85
                # and doge_ticker_df_01['ma12'][-1] > doge_ticker_df_01['ema2'][-1]
                ):
                
                telbot.sendMessage(chat_id=id, text="DOGE long profit final realize" + "\n" + "long max roe : " + str(doge_long_max_roe_01) + "\n" + "long roe : " + str(doge_long_roe_01))
                params = {'positionSide' : 'LONG'}
                data = binance.create_market_sell_order(order_symbol, doge_long_qty_01, params)
            ...
            if  (doge_short_qty_01 == doge_open_amt * -1 and
                doge_short_max_roe_01 > 0.45 and doge_short_max_roe_01 * 0.9 > doge_short_roe_01):
                telbot.sendMessage(chat_id=id, text="DOGE short profit 1st realize" + "\n" + "short max roe : " + str(doge_short_max_roe_01) + "\n" + "short roe : " + str(doge_short_roe_01))
                params = {'positionSide' : 'SHORT'}
                data = binance.create_market_buy_order(order_symbol, doge_open_amt / 4, params)

            # elif (doge_short_qty_01 <= ((doge_open_amt *3) / 4) * -1 and doge_short_qty_01 > doge_open_amt * -1 and
            #     doge_short_roe_01 > 0.88 and
            #     doge_ticker_df_01['ma12'][-1] < doge_ticker_df_01['ema2'][-1]):
            ...
            #     data = binance.create_market_buy_order(order_symbol, doge_open_amt / 4, params)
                ...
                doge_short_max_roe_01 > 0.88 and doge_short_max_roe_01 * 0.9 >doge_short_roe_01):
                telbot.sendMessage(chat_id=id, text="DOGE short profit 2nd realize" + "\n" + "short max roe : " + str(doge_short_max_roe_01) + "\n" + "short roe : " + str(doge_short_roe_01))
                params = {'positionSide' : 'SHORT'}
                data = binance.create_market_buy_order(order_symbol, doge_open_amt / 4, params)
            
            elif( doge_short_qty_01 < 0 and doge_short_max_roe_01 > 1.1 and doge_short_roe_01 > 0.8 and
                doge_short_roe_01 <= doge_short_max_roe_01 * 0.85
                # and doge_ticker_df_01['ma12'][-1] < doge_ticker_df_01['ema2'][-1]
                ):
                
                telbot.sendMessage(chat_id=id, text="DOGE short profit final realize" + "\n" + "short max roe : " + str(doge_short_max_roe_01) + "\n" + "short roe : " + str(doge_short_roe_01))
                params = {'positionSide' : 'SHORT'}
                data = binance.create_market_buy_order(order_symbol, doge_short_qty_01 * -1, params)
    ...
    def order4(self, bal_symbol, order_symbol, eth_open_amt, eth_leverage):
        if(order_symbol == "ETH/USDT"):
            ...
            if(eth_long_qty_01 > 0 and eth_long_open_notice == 1):
                ...
                eth_long_qty_01 = float(eth_L_position['positionAmt'])
                eth_long_entryprice_01 = float(eth_L_position['entryPrice'])
                telbot.sendMessage(chat_id=id, text="ETH Long Open" + "\n" + "entry price : " + str(eth_long_entryprice_01) + "\n" + "amount : " + str(eth_long_qty_01))
                eth_long_open_notice = 0

            # if(eth_long_qty_01 > 0 and eth_long_open_notice == 2):
            #     for position in positions:
            #         if position["symbol"] == bal_symbol and position["positionSide"] == "LONG":
            #             eth_L_position = position
            #     eth_long_qty_01 = float(eth_L_position['positionAmt'])
            #     eth_long_entryprice_01 = float(eth_L_position['entryPrice'])
            #     bot.sendMessage(chat_id=id, text="ETH Long Open(shortage)" + "\n" + "entry price : " + str(eth_long_entryprice_01) + "\n" + "amount : " + str(eth_long_qty_01))
            #     eth_long_open_notice = 0

            # if(eth_short_qty_01 < 0 and eth_short_open_notice == 2):
            #     for position in positions:
            #         if position["symbol"] == bal_symbol and position["positionSide"] == "SHORT":
            #             eth_S_position = position
            #     eth_short_qty_01 = float(eth_S_position['positionAmt'])
            #     eth_short_entryprice_01 = float(eth_S_position['entryPrice'])
            #     bot.sendMessage(chat_id=id, text="ETH Short Open(shortage)" + "\n" + "entry price : " + str(eth_short_entryprice_01) + "\n" + "amount : " + str(eth_short_qty_01))
            #     eth_short_open_notice = 0
            ...
            if (eth_long_qty_01 == 0 and
                eth_ticker_df_01['ema2'][-2] < eth_ticker_df_01['ma1200'][-2] * 0.9996 and
                eth_ticker_df_01['ema2'][-1] > eth_ticker_df_01['ma1200'][-1] * 0.9996):
            ...
            elif (eth_long_qty_01 > 0 and eth_long_qty_01 < eth_open_amt and
                eth_ticker_df_01['ema2'][-2] < eth_ticker_df_01['ma1200'][-2] * 0.9996 and
                eth_ticker_df_01['ema2'][-1] > eth_ticker_df_01['ma1200'][-1] * 0.9996):
                eth_long_loss_cut = eth_ticker_df_01[  'min_low_20'][-1]
            ...
            if (eth_short_qty_01 == 0 and
                eth_ticker_df_01['ema2'][-2] > eth_ticker_df_01['ma1200'][-2] * 1.0004 and
                eth_ticker_df_01['ema2'][-1] < eth_ticker_df_01['ma1200'][-1]* 1.0004):
            ...
            elif (eth_short_qty_01 < 0 and eth_short_qty_01 > eth_open_amt * -1 and
                eth_ticker_df_01['ema2'][-2] > eth_ticker_df_01['ma1200'][-2] * 1.0004 and
                eth_ticker_df_01['ema2'][-1] < eth_ticker_df_01['ma1200'][-1]* 1.0004):
            ...
            ###############################################################################################
            if (eth_long_qty_01 > 0 and
                eth_current_price < eth_long_loss_cut and
                eth_long_roe_01 <= -0.2):
                telbot.sendMessage(chat_id=id, text="ETH Long lose cut" + "\n" + str(eth_long_roe_01) + "\n" + "amount : " + str(eth_long_qty_01))            
                params = {'positionSide' : 'LONG'}
                data = binance.create_market_sell_order(order_symbol, eth_open_amt, params)
                eth_long_loss_cut = 0
                eth_long_roe_01 = 0
            ...
            if (eth_long_qty_01 > 0 and eth_long_roe_01 < -0.45):
                telbot.sendMessage(chat_id=id, text="ETH Long lose cut" + "\n" + str(eth_long_roe_01) + "\n" + "amount : " + str(eth_long_qty_01))            
                params = {'positionSide' : 'LONG'}
                data = binance.create_market_sell_order(order_symbol, eth_open_amt, params)
                eth_long_loss_cut = 0
            ...
            if (eth_long_qty_01 > 0 and eth_long_max_roe_01 > 0.50 and 
                eth_current_price <= eth_long_entryprice_01 and eth_current_price < eth_ticker_df_01['ma1200'][-1] * 0.9996):
                telbot.sendMessage(chat_id=id, text="ETH Long 수익실현 후 lose cut" + "\n" + str(eth_long_roe_01) + "\n" + "amount : " + str(eth_long_qty_01))            
                params = {'positionSide' : 'LONG'}
            ...
            ###############################################################################################
            if (eth_short_qty_01 < 0 and
                eth_ticker_df_01['close'][-1] > eth_short_loss_cut and
                eth_short_roe_01 <= -0.2):
                telbot.sendMessage(chat_id=id, text="ETH Short lose cut" + "\n" + str(eth_short_roe_01) + "\n" + "amount : " + str(eth_short_qty_01))            
                params = {'positionSide' : 'SHORT'}
                data = binance.create_market_buy_order(order_symbol, eth_open_amt, params)
                eth_short_loss_cut = 5000
                eth_short_roe_01 = 0
            ...
            if (eth_short_qty_01 < 0 and eth_short_roe_01 < -0.45):
                telbot.sendMessage(chat_id=id, text="ETH Short lose cut" + "\n" + str(eth_short_roe_01) + "\n" + "amount : " + str(eth_short_qty_01))            
                params = {'positionSide' : 'SHORT'}
                data = binance.create_market_buy_order(order_symbol, eth_open_amt, params)
            ...
            if (eth_short_qty_01 < 0 and eth_short_max_roe_01 > 0.50 and 
                eth_current_price >= eth_short_entryprice_01 and eth_current_price > eth_ticker_df_01['ma1200'][-1] * 1.0004):
                telbot.sendMessage(chat_id=id, text="ETH Short 수익실현 후 lose cut" + "\n" + str(eth_short_roe_01) + "\n" + "amount : " + str(eth_short_qty_01))
                params = {'positionSide' : 'SHORT'}
            ...
            if  (eth_long_qty_01 == eth_open_amt and eth_long_max_roe_01 > 0.45 and eth_long_max_roe_01 * 0.9 > eth_long_roe_01):
                params = {'positionSide' : 'LONG'}
                data = binance.create_market_sell_order(order_symbol, eth_open_amt / 4, params)
                telbot.sendMessage(chat_id=id, text="ETH long profit 1st realize" + "\n" + "long max roe : " + str(eth_long_max_roe_01) + "\n" + "long roe : " + str(eth_long_roe_01))

            # elif (eth_long_qty_01 >= (eth_open_amt * 3) / 4 and eth_long_qty_01 < eth_open_amt and
            #     eth_long_roe_01 > 0.8 and
            #     eth_ticker_df_01['ma12'][-1] > eth_ticker_df_01['ema2'][-1]
            #     ):
            ...
            #     data = binance.create_market_sell_order(order_symbol, eth_open_amt / 4, params)
                ...
                eth_long_max_roe_01 > 0.88 and eth_long_max_roe_01 * 0.9 > eth_long_roe_01):
                telbot.sendMessage(chat_id=id, text="ETH long profit 2nd realize" + "\n" + "long max roe : " + str(eth_long_max_roe_01) + "\n" + "long roe : " + str(eth_long_roe_01))
                params = {'positionSide' : 'LONG'}
                data = binance.create_market_sell_order(order_symbol, eth_open_amt / 4, params)

            elif( eth_long_qty_01 > 0 and eth_long_max_roe_01 > 1.1 and eth_long_roe_01 > 0.8
                and eth_long_roe_01 <= eth_long_max_roe_01 * 0.85
                # and eth_ticker_df_01['ma12'][-1] > eth_ticker_df_01['ema2'][-1]
                ):
                
                telbot.sendMessage(chat_id=id, text="ETH long profit final realize" + "\n" + "long max roe : " + str(eth_long_max_roe_01) + "\n" + "long roe : " + str(eth_long_roe_01))
                params = {'positionSide' : 'LONG'}
                data = binance.create_market_sell_order(order_symbol, eth_long_qty_01, params)
            ...
            if  (eth_short_qty_01 == eth_open_amt * -1 and
                eth_short_max_roe_01 > 0.45 and eth_short_max_roe_01 * 0.9 > eth_short_roe_01):
                telbot.sendMessage(chat_id=id, text="ETH short profit 1st realize" + "\n" + "short max roe : " + str(eth_short_max_roe_01) + "\n" + "short roe : " + str(eth_short_roe_01))
                params = {'positionSide' : 'SHORT'}
                data = binance.create_market_buy_order(order_symbol, eth_open_amt / 4, params)

            # elif (eth_short_qty_01 <= ((eth_open_amt *3) / 4) * -1 and eth_short_qty_01 > eth_open_amt * -1 and
            #     eth_short_roe_01 > 0.88 and
            #     eth_ticker_df_01['ma12'][-1] < eth_ticker_df_01['ema2'][-1]):
            ...
            #     data = binance.create_market_buy_order(order_symbol, eth_open_amt / 4, params)
                ...
                eth_short_max_roe_01 > 0.88 and eth_short_max_roe_01 * 0.9 >eth_short_roe_01):
                telbot.sendMessage(chat_id=id, text="ETH short profit 2nd realize" + "\n" + "short max roe : " + str(eth_short_max_roe_01) + "\n" + "short roe : " + str(eth_short_roe_01))
                params = {'positionSide' : 'SHORT'}
                data = binance.create_market_buy_order(order_symbol, eth_open_amt / 4, params)
            
            elif( eth_short_qty_01 < 0 and eth_short_max_roe_01 > 1.1 and eth_short_roe_01 > 0.8 and
                eth_short_roe_01 <= eth_short_max_roe_01 * 0.85
                # and eth_ticker_df_01['ma12'][-1] < eth_ticker_df_01['ema2'][-1]
                ):
                
                telbot.sendMessage(chat_id=id, text="ETH short profit final realize" + "\n" + "short max roe : " + str(eth_short_max_roe_01) + "\n" + "short roe : " + str(eth_short_roe_01))
                params = {'positionSide' : 'SHORT'}
                data = binance.create_market_buy_order(order_symbol, eth_short_qty_01 * -1, params)
...
while True:
    try:
#     def order(self, bal_symbol, order_symbol, btc_open_amt, btc_leverage):
        # go.order("BTCUSDT", "BTC/USDT", 0.004, 10)
        # go.order2("XRPUSDT", "XRP/USDT", 100, 1)
        # go.order3("DOGEUSDT", "DOGE/USDT", 400, 1)
        go.order4("ETHUSDT", "ETH/USDT", 0.004, 1)
    except:
        pass
